...
```bash
git remote add origin https://github.com/AlessandroLollo/prefect-stitch.git
git branch -M main
git push -u origin main
```

It's recommended to setup some protection rules for main at:
https://github.com/AlessandroLollo/prefect-stitch/settings/branches
